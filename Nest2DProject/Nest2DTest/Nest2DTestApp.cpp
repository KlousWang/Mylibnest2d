...
namespace ET {
    namespace NEST2DTESTAPP {
        ...
        int CetTestApp::_InputLShapeBoard()
        {
            ...
            CetVertices Board = {{0.0, 0.0}, {W, 0.0}, {W, H - CutH}, {W - CutW, H - CutH}, {W - CutW, H}, {0.0, H}};
        ...
        int CetTestApp::_InputEllipse()
        {
            ...
            int Segments = 32;
            std::cout << "Please enter ellipse radius X: ";
            std::cin >> RadiusX;

            std::cout << "Please enter ellipse radius Y: ";
            std::cin >> RadiusY;

            std::cout << "Please enter ellipse rotation angle: ";
            std::cin >> RotationAngle;

            std::cout << "Please enter ellipse segments: ";
            std::cin >> Segments;

            if (!std::cin) {
                std::cout << "Invalid ellipse input." << std::endl;
                return -1;
            }
            if (RadiusX <= 0.0) {
                std::cout << "Invalid ellipse. radius X must be > 0." << std::endl;
                return -1;
            }
            if (RadiusY <= 0.0) {
                std::cout << "Invalid ellipse. radius Y must be > 0." << std::endl;
                return -1;
            }

            if (Segments < 4) {
                std::cout << "Invalid ellipse. segments must be >= 4." << std::endl;
                return -1;
            }
            for (int i = 0; i < count; ++i) {
