...
std::string CetMenuRunnerBase::_GetMenuTitle() const { return "Please select Menu"; }

void CetMenuRunnerBase::_AddMenuItem(int AChoice, const std::string &ADescription, CetMenuFunc AFunc) { m_MenuItems[AChoice] = {ADescription, AFunc}; }

void CetMenuRunnerBase::_Stop() { m_Running = false; }
