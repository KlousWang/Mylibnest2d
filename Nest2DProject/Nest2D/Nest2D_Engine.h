...
namespace ET {
    namespace NEST2DMANAGERLIB {
        ...
        {
        Inherit_Invoke_Hook(CetNest2DEngine) protected : int _Init() override
            {
                CetCoreObject::_Init();
                return 0;
            }
        ...
        protected:
            ...
            std::size_t RunRectangleNestOnce(CetTNestItemVector &ATestItems, const TetNestOptions &AOptions, TetNestProgressTracker &ATracker, bool AUseFillerSelector = false, bool AAllowRotations = true);
            ...
            void _TryOppositeEdgeCandidate(TetLocalBestResult &ALocalBest, const TetClusterBuildResult &AClusterResult, const CetTNestItemVector &AOriginalItems, const TetNestOptions &AOptions, TetNestProgressTracker &ATracker, bool AHasCluster);
            void _TryQuarterTurnCandidates(TetLocalBestResult &ALocalBest, const CetTNestItemVector &AOriginalItems, const TetNestOptions &AOptions, TetNestProgressTracker &ATracker, bool AHasCluster);
