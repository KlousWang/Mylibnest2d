...
namespace ET {
	namespace NEST2DMANAGERLIB {
        ...
        protected:
			...
			bool _RunBoardCompositePass(std::size_t& ALayers, const std::chrono::steady_clock::time_point& ADeadline,
				long long ATimePerBinMs, std::vector<long long>& AExactChecksByBin,
				std::vector<std::size_t>& ARollbackBins, std::vector<std::size_t>& AMovedItems,
			...
			bool _BuildAnchoredCandidateForFiller(int ATargetBin, int ASkeletonIndex, int AFillerIndex,
			...
			bool _EvaluateBoardFillPlacement(std::size_t AItemIndex, int ATargetBin, int AOldBin,
				const TetClusterFreeRegion& AFreeRegion, const libnest2d::Radians& ARotation,
				const libnest2d::Point& ATranslation, long long ACheckLimit, long long& ACheckedCount,
				TetHoleFillCandidate& ABestCandidate);
			void _ProbeContourContactPlacements(std::size_t AItemIndex, int ATargetBin, int AOldBin,
				const TetClusterFreeRegion& AFreeRegion, const libnest2d::Radians& ARotation,
				const CetPath& ARotatedContour, long long AProbeLimit, long long ACheckLimit,
				long long& ACheckedCount, TetHoleFillCandidate& ABestCandidate);
