...
namespace ET {
    namespace NEST2DMANAGERLIB {
        ...
        public:
            ...
            bool IntersectFreeRegionsWithRectangle(const std::vector<TetClusterFreeRegion> &ARegions, double AWidth, double AHeight, std::vector<TetClusterFreeRegion> &AOutRegions) const;
