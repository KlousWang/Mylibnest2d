...
namespace ET {
    namespace NEST2DMANAGERLIB {
        ...
        {
        Inherit_Invoke_Hook(CetTriangleClusterBuilder) protected : bool _SelectRightTriangleRectangleLayout(const RightTriangleRectangleRequest &ARequest, const std::vector<TetRightTriangleRectangleLayout> &ALayouts, TetClusterCandidate &AOutCandidate);
            int _Init() override
            {
                CetCoreObject::_Init();
                return 0;
        ...
        protected:
            ...
            bool _BuildRightTriangleRectangleLayoutCandidate(const TetRightTriangleRectangleLayoutRequest &ARequest, TetClusterCandidate &AOutCandidate);
            ...
            bool _BuildAnyTrianglePairCandidates(const CetTNestItemVector &AOriginalItems, const std::vector<TetShapeFeature> &AFeatures, const std::vector<int> &AIndices, const TetNestOptions &AOptions, std::vector<TetClusterCandidate> &AOutCandidates, TetTrianglePairCell &AOutCell);
            bool _TryBuildAnyTriangleGridCandidate(const CetTNestItemVector &AOriginalItems, const TetNestOptions &AOptions, const std::vector<int> &AIndices, const std::vector<TetClusterCandidate> &APairCandidates, const TetTrianglePairCell &ACell, TetClusterCandidate &AOutCandidate);
            ...
            bool _TryBuildTriangleEdgePairCandidate(const TriangleEdgePairRequest &ARequest);
            bool _PrepareTriangleEdgePair(const TriangleEdgePairRequest &ARequest, TriangleEdgePairGeometry &AOutGeometry);
            bool _BuildTriangleEdgePairCandidateAtOffset(const TriangleEdgePairRequest &ARequest, const TriangleEdgePairGeometry &AGeometry, const TetBaseOffset &ABaseOffset, TetClusterCandidate &AOutCandidate);
