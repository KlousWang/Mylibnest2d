...
namespace ET {
    namespace NEST2DMANAGERLIB {
        ...
        bool CetClusterBoundary::_BuildExactUnionBoundary(const ClipperLib::Paths &AContours, CetPath &AOutBoundary) { return _BuildSingleOuterBoundary(AContours, AOutBoundary); }
        ...
        bool CetClusterBoundary::_SortUniquePoints(std::vector<CetInpoint> &APoints)
        {
            ...
            APoints.erase(std::unique(APoints.begin(), APoints.end(), [](const CetInpoint &AFirstPoint, const CetInpoint &ASecondPoint) { return AFirstPoint.X == ASecondPoint.X && AFirstPoint.Y == ASecondPoint.Y; }), APoints.end());
