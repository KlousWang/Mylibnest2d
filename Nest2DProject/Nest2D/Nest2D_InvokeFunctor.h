...
namespace ET {
    namespace NEST2DMANAGERLIB {
        ...
        public:
            ...
            CetAreaUsageCalculator* Nest2DAreaUsage = nullptr;
        ...
        public:   
         ...
         /*   ET::CORE::CetCoreObjFunctor<void(CetTNestItemVector&,const TetNestOptions&,const CetPolygonImpl&,double,double)> SetPolygonBoardRepairContext;
